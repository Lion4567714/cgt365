...
<<<<<<< Updated upstream
	struct Z_CompiledInDeferFile_FID_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_161625112(TEXT("/Script/ProceduralDungeonEditor"),
		Z_CompiledInDeferFile_FID_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo),
=======
	struct Z_CompiledInDeferFile_FID_Unreal_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProceduralDungeonEditorObject, UProceduralDungeonEditorObject::StaticClass, TEXT("UProceduralDungeonEditorObject"), &Z_Registration_Info_UClass_UProceduralDungeonEditorObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralDungeonEditorObject), 1683771644U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_161625112(TEXT("/Script/ProceduralDungeonEditor"),
		Z_CompiledInDeferFile_FID_Unreal_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_cgt365_Plugins_ProceduralDungeon_Source_ProceduralDungeonEditor_Private_EditorMode_ProceduralDungeonEditorObject_h_Statics::ClassInfo),
>>>>>>> Stashed changes
		nullptr, 0,
		nullptr, 0);
